...
const categories = [
  ...
  { name: "Power Supply", value: "Power Supply", icon: <FaCarBattery /> },
  { name: "Storage", value: "Storage", icon: <MdOutlineSdStorage /> },
...
export default function PCBuild() {
  ...
  const onCompleteSubmit = () => {
    toast.success(
      "Congratualtion! You have succesfully completed your build 🖥️"
    );
    router.push("/");
  };
